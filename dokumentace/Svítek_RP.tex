...
Hodnotu $C_{L,max}$ pro hlavní křídlo byla odečtena z grafu z~2D simulace profilu v~programu XFLR.
...
\begin{itemize}
    ...
    \item \textbf{Fin} --- pevný bez serva, přímosměrná stabilita
          je zajištěna geometrií ocasních ploch.
\end{itemize}
...
Těžiště (CG) je navrženo tak, aby se nacházelo přibližně na 28~\% střední aerodynamické tětivy
 ...
 \begin{figure}[H]
    \centering
    \includegraphics[width=0.7\linewidth]{Cm_alpha.png}
...
na $x_{NP} = 51{,}0$ mm od náběžné hrany hlavního křídla. 
Těžiště je navrženo na $x_{CG} = 37{,}0$ mm od náběžné hrany, 
...
Poloha neutrálního bodu byla ověřena analýzou Cm/$\alpha$ kde záporný 
sklon křivky na obrázku~\ref{fig:Cm}.
...
Do budoucna je plánováno přidání fail-safe módu který by fungoval pokud nepřijde
...
V oladači zůstaly pouze původní joysticky a~vše ostatní bylo odstraněno.
Do těla ovladače bylo umísěno ESP32 a ve předu ovladače je otvor pro HC-12.
Ovladač je napájen z~powerbanky, která poskytuje stabilní 5~V pro ESP32 a~HC-12.
